...
class RetryNetworkRequestViewModel(
    ...
    fun performNetworkRequest() {
        viewModelScope.launch {
            ...
            val result :List<AndroidVersion>?= retriesWithExponentialBackOff(5,::getAndroidVersion)
            if (result!=null){
    ...
    private suspend fun <T> retriesWithExponentialBackOff(retires: Int, block: suspend ()->T?,initialDelay:Long = 100L,maxDelay:Long = 1000L,delayMultiplier:Int=2): T?{
        var result: T? = null
